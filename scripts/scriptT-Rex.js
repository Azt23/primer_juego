...
function cargaImagenes(){
    ...
    imgSuelo = new Image();
    imgFinal = new Image();
    imgRex.src = "imgs/t-rex.png";
    imgNube.src = "imgs/nube.jpg";
    imgCactus.src = "imgs/k.png";
    imgSuelo.src = "imgs/suelo.jpg";
    imgFinal.src = "imgs/gamee.png";
}
...
function dibujaRex(){
    ctx.drawImage(imgRex,0,8,64,69,100,trex.y,50,50);
}

function dibujaCactus(){
    ctx.drawImage(imgCactus,0,0,64,75,cactus.x, cactus.y,64,75);
}
...
function puntuacion(){
    ...
    if(nivel.muerto == true){
        ...
        ctx.drawImage(imgFinal,0,0,425,350,cactus.x, cactus.y,425,-160);
